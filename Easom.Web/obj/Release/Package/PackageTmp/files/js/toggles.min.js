    ...
    $.fn.toggles = function (d) {
        function p(e, b, f, c) {
            ...
            if (c !== r) {
                ...
                if (!k)
                {
                    var l = r ? 0 : -b + f; d.css("margin-left", l);
                    setTimeout(function ()
                    {
                        d.css(x);
                        d.css("margin-left", l)
        ...
        return this.each(function () {
            ...
            if (a.clicker) a.clicker.on("click", function (b) { (b.target != h[0] || !a.drag) && c.trigger("toggle", c.hasClass("active")) }); if (a.drag && !k) {
